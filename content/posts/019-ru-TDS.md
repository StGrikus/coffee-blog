...
[<a href="../019-ua-TDS/">UA</a>/RU]

### **Что такое TDS и уровень экстракции**

![](./019-ru-TDS/dotyk.jpg)
...
Во вторую очередь на уровень экстракции влияют степень обжарки кофе, минерализация воды и разновидность зёрен. Чем темнее обжарен кофе, тем больше в нём твёрдых растворимых веществ, а значит — экстракция протекает быстрее. Влияние воды на экстракцию и вкус кофе подробно разобрано в статье про [воду](../020-ru-water/).
